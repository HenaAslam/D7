...
We declare a variaable using the keyword let. For example, let theFirstVariable="Hello" or let num=10;
...
if(name1===name2.toLocaleLowerCase()){
    console.log("same")
}
else{
    console.log("not same")
